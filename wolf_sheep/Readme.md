# Deer-Tree Predation Model

## Summary

A simple ecological model, consisting of two agent types: Trees and Deer. The deer wander around the grid at random. Deer a expend energy moving around, and replenish it by eating trees. This is based off the model listed below as the Wolf-Sheep Predation Model. to run this model, follow the installation steps listed below in reference to the Wolf-Sheep Predation Model but replace the folder examples/wolf_sheep with the folders listed within this project. This model has been built using mesa concepts and features
